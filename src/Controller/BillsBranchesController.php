 ...
 * @method \App\Model\Entity\BillsBranch[]|\Cake\Datasource\ResultSetInterface paginate($object = null, array $settings = [])
 */
class BillsBranchesController extends AppController
{
    ...
    {
        $billsBranches = $this->paginate($this->BillsBranches);
