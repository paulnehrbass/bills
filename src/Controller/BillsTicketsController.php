...
class BillsTicketsController extends AppController
{
    ...
    {
        $query = $this->BillsTickets->find()
            ->contain(['BillsStates', 'BillsBranches']);
        $billsTickets = $this->paginate($query);
    ...
    {
        $billsTicket = $this->BillsTickets->get($id, contain: ['BillsStates', 'BillsBranches']);
    ...
    {
        $billsTicket = $this->BillsTickets->get($id, contain: []);
